...
var InputNumber = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  var createUpButton = function createUpButton2() {
    ...
    var icon = props.incrementButtonIcon || React.createElement(AngleUpIcon, incrementIconProps);
    ...
    return React.createElement("button", incrementButtonProps, upButton, React.createElement(Ripple, null));
  };
  var createDownButton = function createDownButton2() {
    var decrementIconProps = mergeProps({
      className: cx("decrementIcon")
    }, ptm("decrementIcon"));
    var icon = props.decrementButtonIcon || React.createElement(AngleDownIcon, decrementIconProps);
    ...
    return React.createElement("button", decrementButtonProps, downButton, React.createElement(Ripple, null));
  };
  var createButtonGroup = function createButtonGroup2() {
    ...
    if (stacked) {
      return React.createElement("span", buttonGroupProps, upButton, downButton);
    }
    return React.createElement(React.Fragment, null, upButton, downButton);
  };
  ...
  return React.createElement(React.Fragment, null, React.createElement("span", _extends({
    ref: elementRef
  }, rootProps), inputElement, buttonGroup), hasTooltip && React.createElement(Tooltip, _extends({
    target: elementRef,
...
//# sourceMappingURL=chunk-4MUW2ICS.js.map
