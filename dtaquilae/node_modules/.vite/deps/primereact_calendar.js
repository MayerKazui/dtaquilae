...
var Calendar = React2.memo(React2.forwardRef(function(inProps, ref) {
  ...
  var isTypingRef = React2.useRef(false);
  var metaData = {
    props,
    state: {
  ...
  var createDateViewGrid = function createDateViewGrid2(monthMetaData, weekDays, groupIndex) {
    ...
    return currentView === "date" && React2.createElement("div", containerProps, React2.createElement("table", tableProps, React2.createElement("thead", tableHeaderProps, React2.createElement("tr", tableHeaderRowProps, dayNames)), React2.createElement("tbody", tableBodyProps, dates)));
  };
  var createMonth = function createMonth2(monthMetaData, index) {
    ...
    return React2.createElement("div", _extends2({}, groupProps, {
      key: monthKey
    }), React2.createElement("div", headerProps, header, backwardNavigator, title, forwardNavigator), dateViewGrid);
  };
